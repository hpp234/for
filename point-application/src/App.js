...
//  合约地址
const UNIVERSAL_POINTS_ADDRESS = "0x9c82192E8840d70B990a5b12670699A9b814047E";
const POINTS_EXCHANGE_ADDRESS  = "0xE067Dea4543f1e26B5a85481BA7d758b62D2E5F5";
...
function App() {
  ...
  return (
    <div className="App">
      <h1>Blockchain-based Points Redemption Platform</h1>
      ...
      {!isWalletConnected ? (
        ...
        <div>
          ...
          <div>
            <h2>Deploy a Standard Points Contract</h2>
            <input
              type="text"
              placeholder="name"
              value={name}
            ...
            />
            <button onClick={handleDeploy}>Deploy a General Purpose Points Issuance Contract</button>
          </div>

          <div>
            <h2>Import a Standard Points Contract</h2>
            <input
              type="text"
            ...
            />
            <button onClick={handleLoadContract}>Import Contract</button>
          </div>
  
          <div>
            <h2>General Points Issuance</h2>
            <input
              type="number"
              value={amountToMint}
              ...
              placeholder="amount"
            />
            <button onClick={issueRegularPoints}>Points Issuance</button>
          </div>
  
          <div>
            <h2>Points Balance</h2>
            <p>General Points Balance: {universalPointsBalance} UPT</p>
            <p>Regular Points Balance: {userPointsBalance} {symbol || 'RLP'}</p>
            <button onClick={getPointsBalance}>Update Balance</button>
          </div>
  
          <div>
            <h2>Points Exchange</h2>
            <p>Exchange Rate: 1 {symbol || 'RLP'} = {exchangeRate} UPT</p>
            <button onClick={exchangePoints}>Exchange</button>
          </div>
        </div>
      )}
    </div>
