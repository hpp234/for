...
//  合约地址
const MYNFT_ADDRESS = "0xcAA1534295570892cAC26ec91164DD382bd2028C";
const MARKET_ADDRESS = "0xe2b23196b37609397CA0E45fc557032cfa477982";
    ...
    <div className="App">
      ...
      {!account ? (
        ...
        <div>
          ...
          <h2>Your NFT</h2>
          {userNFTs.length === 0 ? (
            <p>You don't have your own NFT</p>
          ) : (
